...
The raster should contain one categorical band with the current mapped land-use
or habitat class. The exact integer codes are not assumed in the script; they
are documented in `Data/habitat_lookup.csv`.
